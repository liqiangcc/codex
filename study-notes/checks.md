...
test -f study-notes/stage-goals.md
test -f study-notes/stage-2-source-reading.md
test -f study-notes/stage-3-extensions.md
test -f study-notes/stage-4-upstream-contribution.md
...
rg "主题矩阵|完成标准|阶段边界" \
  study-notes/stage-2-source-reading.md \
  study-notes/stage-3-extensions.md \
  study-notes/stage-4-upstream-contribution.md
```
...
- 四个阶段都有目标、执行入口和完成标准；阶段二至四包含主题矩阵与范围边界。
